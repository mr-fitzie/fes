...
public class FesConstants {
    ...
    // Fragment Tags
    public static final String TALLY_GREETED_NO_ENG = "tally_greeted_no_eng";
    public static final String TALLY_NO_INTEREST = "tally_no_interest";
    public static final String TALLY_DQ_NOT_HO = "tally_dq_not_ho";
    public static final String TALLY_PHONE_LEAD = "tally_phone_lead";
    public static final String TALLY_WON_OPP = "tally_won_opp";
    public static final String DAILY_NOTES = "daily_notes";

    // Preference Keys
    public static final String PREF_FES_NAME = "pref_fes_name";
